...
to {
  ...
  animation: ${ne} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,ie=({toast:e})=>{let{icon:t,type:n,iconTheme:r}=e;return t===void 0?n===`blank`?null:i.createElement(Z,null,i.createElement(K,{...r}),n!==`loading`&&i.createElement(X,null,n===`error`?i.createElement(W,{...r}):i.createElement(Y,{...r}))):typeof t==`string`?i.createElement(re,null,t):t},ae=e=>`
0% {transform: translate3d(0,${e*-200}%,0) scale(.6); opacity:.5;}
100% {transform: translate3d(0,0,0) scale(1); opacity:1;}
`,oe=e=>`
0% {transform: translate3d(0,0,-1px) scale(1); opacity:1;}
100% {transform: translate3d(0,${e*-150}%,-1px) scale(.6); opacity:0;}
`,se=`0%{opacity:0;} 100%{opacity:1;}`,ce=`0%{opacity:1;} 100%{opacity:0;}`,le=x(`div`)`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
...
`,de=(e,t)=>{let n=e.includes(`top`)?1:-1,[r,i]=T()?[se,ce]:[ae(n),oe(n)];return{animation:t?`${y(r)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${y(i)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}},Q=i.memo(({toast:e,position:t,style:n,children:r})=>{let a=e.height?de(e.position||t||`top-center`,e.visible):{opacity:0},o=i.createElement(ie,{toast:e}),s=i.createElement(ue,{...e.ariaProps},C(e.message,e));return i.createElement(le,{className:e.className,style:{...a,...n,...e.style}},typeof r==`function`?r({icon:o,message:s}):i.createElement(i.Fragment,null,o,s))});b(i.createElement);var fe=({id:e,className:t,style:n,onHeightUpdate:r,children:a})=>{let o=i.useCallback(t=>{if(t){let n=()=>{let n=t.getBoundingClientRect().height;r(e,n)};n(),new MutationObserver(n).observe(t,{subtree:!0,childList:!0,characterData:!0})}},[e,r]);return i.createElement(`div`,{ref:o,className:t,style:n},a)},pe=(e,t)=>{let n=e.includes(`top`),r=n?{top:0}:{bottom:0},i=e.includes(`center`)?{justifyContent:`center`}:e.includes(`right`)?{justifyContent:`flex-end`}:{};return{left:0,right:0,display:`flex`,position:`absolute`,transition:T()?void 0:`all 230ms cubic-bezier(.21,1.02,.73,1)`,transform:`translateY(${t*(n?1:-1)}px)`,...r,...i}},me=h`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`,$=16,he=({reverseOrder:e,position:t=`top-center`,toastOptions:n,gutter:r,children:a,toasterId:o,containerStyle:s,containerClassName:c})=>{let{toasts:l,handlers:u}=B(n,o);return i.createElement(`div`,{"data-rht-toaster":o||``,style:{position:`fixed`,zIndex:9999,top:$,left:$,right:$,bottom:$,pointerEvents:`none`,...s},className:c,onMouseEnter:u.startPause,onMouseLeave:u.endPause},l.map(n=>{let o=n.position||t,s=pe(o,u.calculateOffset(n,{reverseOrder:e,gutter:r,defaultPosition:t}));return i.createElement(fe,{id:n.id,key:n.id,onHeightUpdate:u.updateHeight,className:n.visible?me:``,style:s},n.type===`custom`?C(n.message,n):a?a(n):i.createElement(Q,{toast:n,position:o}))}))},ge=z,_e=t((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),ve=t(((e,t)=>{t.exports=_e()})),ye={saveUser:e=>{localStorage.setItem(`userData`,JSON.stringify(e))},getUser:()=>{try{let e=localStorage.getItem(`userData`);return e?JSON.parse(e):null}catch(e){return console.error(`Failed to parse user data`,e),null}},setLoginStatus:e=>{localStorage.setItem(`isLoggedIn`,e)},getLoginStatus:()=>localStorage.getItem(`isLoggedIn`)===`true`,clearAll:()=>{localStorage.removeItem(`userData`),localStorage.removeItem(`isLoggedIn`)},logout:()=>{localStorage.removeItem(`isLoggedIn`)},getCustomers:()=>{try{return JSON.parse(localStorage.getItem(`customers`))??null}catch{return null}},saveCustomers:e=>{localStorage.setItem(`customers`,JSON.stringify(e))},deleteCustomer:e=>{let t=JSON.parse(localStorage.getItem(`customers`)).filter(t=>t.id!==e);localStorage.setItem(`customers`,JSON.stringify(t))},getOrders:()=>{try{return JSON.parse(localStorage.getItem(`orders`))??null}catch{return null}},getNextInvoiceNumber:()=>{let e=parseInt(localStorage.getItem(`invoiceCounter`)||`0`)+1;return localStorage.setItem(`invoiceCounter`,e.toString()),`INV-${String(e).padStart(4,`0`)}`},saveOrders:e=>{localStorage.setItem(`orders`,JSON.stringify(e))},clearOrders:()=>{localStorage.removeItem(`orders`)},getBeats:()=>{try{return JSON.parse(localStorage.getItem(`beats`))??null}catch{return null}},saveBeats:e=>{localStorage.setItem(`beats`,JSON.stringify(e))},getNextBeatId:()=>{let e=parseInt(localStorage.getItem(`beatCounter`)||`0`)+1;return localStorage.setItem(`beatCounter`,e.toString()),`BEAT-${String(e).padStart(3,`0`)}`},getVisits:()=>{try{return JSON.parse(localStorage.getItem(`beatVisits`))??null}catch{return null}},saveVisits:e=>{localStorage.setItem(`beatVisits`,JSON.stringify(e))},getProducts:()=>{try{return JSON.parse(localStorage.getItem(`products`))??null}catch{return null}},saveProducts:e=>{localStorage.setItem(`products`,JSON.stringify(e))}};export{r as a,ge as i,ve as n,he as r,ye as t};