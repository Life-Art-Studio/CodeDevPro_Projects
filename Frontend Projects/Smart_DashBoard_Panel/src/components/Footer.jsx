...
const Footer = () => {
  return (
    <footer className="w-full py-5 px-6 border-t border-slate-200/30 dark:border-white/15 bg-white/30 dark:bg-[#0a0c14]/60 backdrop-blur-xl mt-auto z-10 shrink-0 flex-shrink-0 transition-colors duration-500 fixed bottom-0 left-0 md:relative md:mt-0">
