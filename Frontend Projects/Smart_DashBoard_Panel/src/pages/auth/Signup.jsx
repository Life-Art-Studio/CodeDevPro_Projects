  ...
  return (
    <div className="w-full max-w-md bg-white dark:bg-[#1a1d27] shadow-sm rounded-3xl p-8 border border-white/20 transition-colors animate-in fade-in duration-500 relative overflow-hidden group">
      ...
      <div className="text-center mb-8 relative z-10">
        <h2 className="text-3xl font-bold text-gray-800 dark:text-zinc-100 transition-colors tracking-tight">Admin Registration</h2>
        <p className="text-gray-500 dark:text-zinc-400 mt-2 text-sm transition-colors">Register a new admin account</p>
      </div>
      ...
      <form className="flex flex-col gap-5 relative z-10" onSubmit={handleSubmit}>
        ...
        {/* Full Name Input - NEW */}
        <div>
          <label htmlFor="name" className="block text-sm font-medium text-gray-700 dark:text-zinc-300 mb-1.5 transition-colors">
            Full Name
          </label>
          <div className="relative">
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-white border border-zinc-200 dark:border-zinc-800 dark:text-zinc-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all shadow-inner focus:shadow-[0_0_15px_rgba(168,85,247,0.2)]"
              value={formData.name}
              onChange={(e) =>
        ...
        {/* Email Input */}
        <div>
          <label htmlFor="email" className="block text-sm font-medium text-gray-700 dark:text-zinc-300 mb-1.5 transition-colors">
            Email Address
          </label>
          <div className="relative">
        ...
        {/* Password Input */}
        <div>
          <label htmlFor="password" className="block text-sm font-medium text-gray-700 dark:text-zinc-300 mb-1.5 transition-colors">
            Password
          </label>
          <div className="relative">
            <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-zinc-400">🔒</span>
