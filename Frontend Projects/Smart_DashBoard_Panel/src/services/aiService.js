...
const OPENROUTER_API_KEY = atob("c2stb3ItdjEtZWM2MTM1M2EyY2U3ZDgxYzQ0YjFkYmI1MWJkZmM0MzYwNWM5NzE4ZDIxM2YwYWE3NDkyZjBiZWFlMDhhZWYyMg==");
      ...
      if (Array.isArray(responseJson)) {
        const fullProducts = responseJson.map((item, idx) => {
          ...
          return {
            ...
            sku,
            description: `AI suggested ${item.name.toLowerCase()} for the ${sectorId} industry.`,
