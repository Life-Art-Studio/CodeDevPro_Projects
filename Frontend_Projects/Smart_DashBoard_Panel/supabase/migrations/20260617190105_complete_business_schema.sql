...
ALTER TABLE public.orders DROP CONSTRAINT IF EXISTS orders_owner_id_fkey;
...
ALTER TABLE public.visits DROP CONSTRAINT IF EXISTS visits_owner_id_fkey;
...
ALTER TABLE public.super_stockists DROP CONSTRAINT IF EXISTS super_stockists_owner_id_fkey;
...
ALTER TABLE public.inventory_ledger DROP CONSTRAINT IF EXISTS inventory_ledger_owner_id_fkey;
...
ALTER TABLE public.invoices DROP CONSTRAINT IF EXISTS invoices_owner_id_fkey;
